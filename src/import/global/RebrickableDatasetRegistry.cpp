...
const QVector<RebrickableDatasetDescriptor>& RebrickableDatasetRegistry::datasets()
{
    static const QVector<RebrickableDatasetDescriptor> registry = {
        {RebrickableDatasetId::Themes, "Themes", "themes.csv", {"id", "name", "parent_id"}, {}, 1, true, false, true},
        {RebrickableDatasetId::Colors, "Colors", "colors.csv", {"id", "name", "rgb", "is_trans"}, {}, 2, true, false, false},
        {RebrickableDatasetId::PartCategories, "Part Categories", "part_categories.csv", {"id", "name"}, {}, 3, true, false, false},
        {RebrickableDatasetId::Parts, "Parts", "parts.csv", {"part_num", "name", "part_cat_id", "part_material"}, {RebrickableDatasetId::PartCategories}, 4, true, false, false},
