...
#include <QDialog>
class QComboBox; class QDoubleSpinBox; class QLabel; class QLineEdit; class QPushButton; class QShowEvent; class QSpinBox; class QTabWidget; class QTableWidget; class QTimer;
class FitCalibrationDialog : public QDialog {
    Q_OBJECT
public: explicit FitCalibrationDialog(QWidget* parent=nullptr);
protected: void showEvent(QShowEvent*) override;
private:
    ...
    void loadSession(); void resumeManagedSession(); void exportSession(); void createFitProfile(); void newTechnicCalibration(); void newStudCalibration(); void newReceivingClutchCalibration(); void refreshLibrary(); void scheduleManagedSave();
    ...
    QDoubleSpinBox *m_nozzle=nullptr,*m_layer=nullptr,*m_measured=nullptr; QComboBox *m_orientation=nullptr,*m_result=nullptr,*m_sessions=nullptr,*m_features=nullptr; QSpinBox* m_repeat=nullptr; QTimer* m_autoSave=nullptr;
    QTabWidget* m_tabs=nullptr; QTableWidget *m_coarseTable=nullptr,*m_fineTable=nullptr; QLabel *m_identity=nullptr,*m_coarseContext=nullptr,*m_fineContext=nullptr,*m_guidance=nullptr; QPushButton *m_save=nullptr,*m_generate=nullptr,*m_verify=nullptr,*m_newReceiving=nullptr;
};
