...
private:
    ...
    void loadSession(); void resumeManagedSession(); void exportSession(); void createFitProfile(); void newStudCalibration(); void refreshLibrary(); void scheduleManagedSave();
