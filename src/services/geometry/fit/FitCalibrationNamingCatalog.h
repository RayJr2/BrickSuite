...
public:
    static constexpr std::array<FitCalibrationName, 25> entries() {
        return {{{FitCalibrationNameKey::RoundPassagePerpendicular, "Technic Hole — Round Passage — Perpendicular", "TH-R-PERP", "technic-hole-round-perpendicular"},
                 ...
                 {FitCalibrationNameKey::PlainWheelBlindBorePerpendicular, "Plain Round-Bore Wheel — Blind Bearing — Perpendicular", "WHEEL-PLAIN-PERP", "plain-round-bore-wheel-perpendicular"}}};
    }
    ...
    static FitCalibrationNameKey keyFor(const FitCalibrationExperiment& experiment,
        ...
        if (experiment.featureFamily == QStringLiteral("PlainRoundBoreWheel"))
            return FitCalibrationNameKey::PlainWheelBlindBorePerpendicular;
    ...
    static QString canonical(const FitCalibrationExperiment& experiment, FitPrintedOrientation orientation) {
        if (experiment.featureFamily != QStringLiteral("RoundTechnicPassage") &&
            ...
            experiment.featureFamily != QStringLiteral("PlainRoundBoreWheel"))
