...
enum class FunctionalInterfaceFamily { RoundTechnicPassage, StandardStud, StudReceivingClutch, FrictionlessTechnicPin, FrictionTechnicPin, TechnicAxle, TechnicAxleHole, StandardBar, CClipBarReceiver, BallJoint, BallSocket, PinBarrelHinge, InterleavedFingerHinge, ClickHinge };
