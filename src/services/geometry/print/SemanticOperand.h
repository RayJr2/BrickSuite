...
enum class FunctionalInterfaceFamily { RoundTechnicPassage, StandardStud, StudReceivingClutch, FrictionlessTechnicPin, FrictionTechnicPin, TechnicAxle, TechnicAxleHole, StandardBar };
