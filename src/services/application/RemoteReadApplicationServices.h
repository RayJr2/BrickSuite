...
public:
    ...
    ReadRequestToken exportInventory(const RemoteReadDto::InventorySearchRequest& request,
        QObject* context, AsyncReadCompletion<RemoteReadDto::Page<RemoteReadDto::InventoryExportRow>> completion);
    ...
    ReadRequestToken exportCollection(const RemoteReadDto::CollectionSearchRequest& request,
        QObject* context, AsyncReadCompletion<RemoteReadDto::Page<RemoteReadDto::CollectionExportRow>> completion);
    ...
    ReadRequestToken collectionDisassemblyPlan(qint64 workspaceId, qint64 collectionItemId,
        QObject* context,
        AsyncReadCompletion<RemoteReadDto::CollectionDisassemblyPlan> completion);
