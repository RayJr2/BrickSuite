...
{ return {{"buildId",double(v.buildId)},{"workspaceId",double(v.workspaceId)},{"buildType",v.buildType},{"name",v.name},{"setNumber",v.setNumber},{"minifigNumber",v.minifigNumber},{"inventoryMode",v.inventoryMode},{"status",v.status},{"active",v.active}}; }
