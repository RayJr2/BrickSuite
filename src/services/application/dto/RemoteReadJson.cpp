...
QJsonObject toJson(const RemoteReadDto::InventoryDetail& v){QJsonObject o=toJson(static_cast<const RemoteReadDto::InventoryRow&>(v));o["allocatedQuantity"]=v.allocatedQuantity;o["createdUtc"]=utc(v.createdUtc);o["modifiedUtc"]=utc(v.modifiedUtc);return o;}
bool fromJson(const QJsonObject&o,RemoteReadDto::InventoryDetail*v,DecodeError*e){qint64 allocated=0;if(!fromJson(o,static_cast<RemoteReadDto::InventoryRow*>(v),e)||(o.contains("allocatedQuantity")&&!integer(o,"allocatedQuantity",0,INT_MAX,&allocated))||!parseUtc(o.value("createdUtc"),&v->createdUtc)||!parseUtc(o.value("modifiedUtc"),&v->modifiedUtc))return false;v->allocatedQuantity=int(allocated);return true;}
