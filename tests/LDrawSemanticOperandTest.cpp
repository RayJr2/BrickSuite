...
int main(int argc,char**argv)
{
    ...
    for(const QString&id:{QStringLiteral("3001"),QStringLiteral("3622"),QStringLiteral("3700"),QStringLiteral("11477"),QStringLiteral("32064a"),QStringLiteral("3037"),QStringLiteral("6553")}){
